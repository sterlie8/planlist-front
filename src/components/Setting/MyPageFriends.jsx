...
import "../styles/MyPageFriends.css";
    ...
    <div className="friends-page">
      <div className="friends-content">
        ...
        <div className="tabs-container">
          <Link to="/" className="profile-tab">
            <div className="profile-tab-inner">
              <div className="profile-tab-text">profile</div>
            </div>
          </Link>
          
          <div className="friends-tab">
            <div className="friends-tab-inner">
              <div className="friends-tab-text">friends</div>
              <div className="friends-tab-border"></div>
            </div>
          </div>
        </div>
